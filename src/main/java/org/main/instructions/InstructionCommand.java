...
import org.main.instructions.parameters.Parameter;
...
public class InstructionCommand {
    ...
    public Parameter getFirstParam() { // for use in calling function chain
        return parameter1;
    }

    public void setFirstParam(Parameter param) { // for use in calling function chain
        parameter1 = param;
    }
